...
import { InputEventTransformed_2024_06_14 } from "@/ee/event-types/event-types_2024_06_14/transformed/event-type.tranformed";
import { transformBookerLayoutsApiToInternal } from "@/ee/event-types/event-types_2024_06_14/transformers/api-to-internal/booker-layouts";
import { transformBookingFieldsApiToInternal } from "@/ee/event-types/event-types_2024_06_14/transformers/api-to-internal/booking-fields";
import { transformConfirmationPolicyApiToInternal } from "@/ee/event-types/event-types_2024_06_14/transformers/api-to-internal/confirmation-policy";
import { transformEventColorsApiToInternal } from "@/ee/event-types/event-types_2024_06_14/transformers/api-to-internal/event-colors";
import { transformFutureBookingLimitsApiToInternal } from "@/ee/event-types/event-types_2024_06_14/transformers/api-to-internal/future-booking-limits";
import { transformIntervalLimitsApiToInternal } from "@/ee/event-types/event-types_2024_06_14/transformers/api-to-internal/interval-limits";
import { transformLocationsApiToInternal } from "@/ee/event-types/event-types_2024_06_14/transformers/api-to-internal/locations";
import { transformRecurrenceApiToInternal } from "@/ee/event-types/event-types_2024_06_14/transformers/api-to-internal/recurrence";
import { transformSeatsApiToInternal } from "@/ee/event-types/event-types_2024_06_14/transformers/api-to-internal/seats";
import {
  InternalLocation,
