...
const t = useTranslations("range-slider-demo");
  ...
  return (
    <RenderComponentWithSnippet>
      <div className="space-y-6 md:w-80">
        ...
        <div className="space-y-2">
          <h3 className="text-emphasis text-sm font-medium">{t('examples.custom-range-heading')}</h3>
          <RangeSliderPopover
        ...
        <div className="space-y-2">
          <h3 className="text-emphasis text-sm font-medium">{t('examples.large-range-heading')}</h3>
          <RangeSliderPopover
        ...
        <div className="mt-4">
          <h4 className="text-default text-sm font-medium">{t('labels.selected-values')}</h4>
