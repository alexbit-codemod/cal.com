...
export const CustomIconsExample: React.FC = () => {
  const t = useTranslations("alert-custom-icons-demo");
      ...
      <div className="not-prose space-y-4">
        {severities.map((severity, index) => (
          <Alert
            ...
            title={t('titles.severity-alert-with-custom-icon', { severity: severity.charAt(0).toUpperCase() + severity.slice(1) })}
            message={t('messages.custom-icon-description')}
          />
        ))}
      </div>
    </RenderComponentWithSnippet>
