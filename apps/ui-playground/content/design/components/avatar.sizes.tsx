...
return (
        <div key={size} className="flex flex-col items-center gap-2">
          <Avatar size={size} alt={t('alt-text.size-variant', { "size": size })} imageSrc={sampleImage} />
...
return (
        <div key={size} className="flex flex-col items-center gap-2">
          <Avatar size={size} alt={t('alt-text.size-variant', { "size": size })} imageSrc={sampleImage} shape="square" />
          <span className="text-subtle text-xs">{size}</span>
        </div>
      )
})}
