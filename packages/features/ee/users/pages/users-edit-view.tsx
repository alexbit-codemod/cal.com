...
const UsersEditPage = () => {
  ...
  if (!input.success) return // To safely replace this hard-coded string with a translation key  talk to us to get access to our i18n pro codemods. https://cal.com/codemod
  $$$;
